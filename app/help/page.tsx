...
const TOPICS: Topic[] = [
  {
    ...
    articles: [
      ...
      { q: 'What is the sub portal?',
        a: 'A private web page your sub accesses without an account. They can update task status, confirm dates, set crew size, and submit their quoted price for Sofia AI to compare.',
        link: '/projects', linkLabel: 'Go to Projects' },
      { q: 'How do I send an SMS to a sub?',
        a: 'In the Subs tab, tap "📱 Send SMS Update" on any sub\'s card. Sofia AI sends an automatic SMS when you complete a predecessor task too.',
        link: '/projects', linkLabel: 'Go to Subs' },
  ...
  },
  {
    ...
    articles: [
      ...
      { q: 'Can my sub submit their quoted price?',
        a: 'Yes — the sub opens their portal → taps "💵 My Quoted Price" on a task → enters their price. Sofia AI compares it to your estimate and sends an alert if the variance is significant.',
        link: '/projects', linkLabel: 'Go to Projects → Quote' },
      { q: 'How does Sofia compare sub quotes to my estimate?',
        a: 'Sofia calculates the % difference between the sub\'s submitted price and the line item total in your quote. If it\'s over/under budget she sends you an alert with the exact variance.',
  ...
  },
  {
    ...
    articles: [
      ...
      { q: 'What inspection statuses are available?',
        a: 'Not Required, Pending, Scheduled, Passed, or Failed. Sofia AI sends an alert when an inspection fails.',
        link: '/projects', linkLabel: 'Go to Inspections' },
    ],
  },
  {
    id: 'sofia', icon: '🤖', title: 'Sofia AI',
    subtitle: 'Automatic alerts, SMS cascade and quote comparison',
    color: 'bg-purple-50 border-purple-100',
    keywords: ['sofia','ai','artificial','intelligence','inteligencia','alert','alerta','notification','notificacion','sms','automatic','automatico','monitor','cascade','delay'],
    articles: [
      { q: 'What does Sofia AI do?',
        a: 'Sofia monitors your project 24/7: reads SMS replies from subs, compares sub quotes to your estimate, auto-triggers SMS on task completion, and sends delay/over-budget alerts.',
        link: '/notifications', linkLabel: 'Go to Alerts' },
      { q: 'Where do I see Sofia\'s alerts?',
        a: 'Tap the 🔔 Alerts tab in the bottom navigation. The red badge shows unread alert count.',
        link: '/notifications', linkLabel: 'Go to Alerts' },
      { q: 'Does Sofia send SMS automatically?',
        a: 'Yes — when you mark a task as Completed, Sofia notifies the next sub in the chain. She also sends a welcome SMS when a new sub registers.',
        link: '/notifications', linkLabel: 'Go to Alerts' },
    ],
  },
  {
